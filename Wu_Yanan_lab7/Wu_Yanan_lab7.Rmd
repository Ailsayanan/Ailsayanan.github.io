...
ct$estimate[[1]]
if (ct$p.value > 0.05){
  print("The null hypothesize is true")
}else{
  print("The null hypothesize is not true")
}
```
...
if (test$p.value > 0.05){
  ...
  print("This is not a null hypothesis")
}
```
...
if (test2$p.value>0.05){
  print("It is not different from zero")
}else{
  print("It is different from zero")
}
```
...
```{r}
t.36 <- qt(0.975, df = 34)
r.36 <- sqrt(t^2/(34 + t^2))

t.80 <- qt(0.975, df = 78)
r.80 <- sqrt(t^2/(78 + t^2))
...
if (result$p.value>0.05){
  print("The two data is not correlation")
}else{
  print("The two daa is correlation")
}
```
...
test$p.value
if (test$p.value > 0.05){
  print("The correlation coefficient is equal to zero")
}else{
  print("The correlation coefficient is not equal to zero")
}
```
...
es.value[[1]]
if (test$p.value > 0.1){
  print("The true correlation is equal to zero")
}else{
  print("The true correlation is not equal to zero")
}
```
...
estimate
if (estimate > 0.05){
  print("It has correlation coefficient")
}else{
  print("It does not have correlation coefficient")
}
```
